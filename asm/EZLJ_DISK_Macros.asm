...
inline n64dd_ROMInfoEnd(label, variable start, variable end) {
...
inline n64dd_RamSetAddress(variable addr) {
...
inline n64dd_Align(variable align) {
	fill ((origin() - {LBA1_OFFSET}) % align)
}
