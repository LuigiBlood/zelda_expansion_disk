...
define LBA1_OFFSET = ({LBA0_OFFSET} + 0x4D08)

if !{defined D64} {
	if {defined USA} {
		print "USA Region\n"
		output "../EZLE_Ura.ndd", create
	} else {
		print "JPN Region\n"
		output "../EZLJ_Ura.ndd", create
	}
} else {
	if {defined USA} {
		print "USA Region\n"
		output "../EZLE_Ura.rom", create
	} else {
		print "JPN Region\n"
		output "../EZLJ_Ura.rom", create
	}
}
...
constant EZLJ_SAVE_ID = (0x5552415A)		//"URAZ"
